...
namespace Magenta\Bundle\CBookMediaApiBundle\Serializer\Organisation;
 ...
 */
class PublicUrlSerializerHandler implements SerializerHandlerInterface
{
    /**
    ...
    {
        return 'magenta_public_media_url';
    }
}
